...
def queryMessage = 'SELECT * FROM message WHERE  JSON_EXTRACT(payload, "$.content.sharedData.origEvReqId")= ?'
def applicationId = ""
def messageType = "B"

//Build message with Kafka Producer
...
log.info("There is no message into the db produced for: " + docT)
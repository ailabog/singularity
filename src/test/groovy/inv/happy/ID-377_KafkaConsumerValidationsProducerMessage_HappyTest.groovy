...
String current_date_complete = date.format(now)

UUID generateUUID = UUID.randomUUID()
def unique_group_id = "automation_doc_events_consumer" + current_date_complete
...
eventHeader.put("eventDateTime", current_date_complete)
eventHeader.put("eventGeneratedDateTime", current_date_complete)
